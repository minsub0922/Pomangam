...
protocol TabmenuBarDelegate: class {
    func tabmenuBar(scrollTo index: Int)
}

class TabmenuBar: UIView {
    weak var delegate: TabmenuBarDelegate?
    ...
    func setupCollectioView(){
        ...
        customTabBarCollectionView.registerNib(TabmenuBarCell.self)
...
extension TabmenuBar: UICollectionViewDelegate, UICollectionViewDataSource {
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(TabmenuBarCell.self, for: indexPath)
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.tabmenuBar(scrollTo: indexPath.row)
        guard let cell = collectionView.cellForItem(at: indexPath) as? TabmenuBarCell else {return}
